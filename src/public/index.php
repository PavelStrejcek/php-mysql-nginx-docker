<?php
// Simple index to verify PHP-FPM, Apache HTTPD, and MySQL setup
...
<body>
<h1>It works!</h1>
<p>You are running <strong>PHP <?= htmlspecialchars($phpVersion, ENT_QUOTES) ?></strong> behind Apache HTTPD 2.4 (FPM via proxy_fcgi).</p>
